...
Данный командный проект представляет собой собственную реализацию типа данных **decimal.h**, и функций по работе с ним. Конкретно я в этом проекте отвечал за реализацию функций сравнения, сборку и немного поработал с самим типом данных s21_decimal.
...
---
## Структура проекта
- `src/s21_decimal.c` — реализация типа данных s21_decimal и функций по работе с ним
- `src/s21_decimal.h` — заголовочный файл типа данных s21_decimal
- `src/tests` — Unit-тесты (с помощью библиотеки Check)
- `src/Makefile` — Сборка проекта
---
## Установка и запуск
**Клонирование репозитория**
```bash
git clone https://github.com/School21-projects/C5_s21_decimal-3.git
cd C5_s21_decimal-3
```
**Сборка**
```bash
...
make gcov_report
# Проверка cppcheck и clang-format
make style
